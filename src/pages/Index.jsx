      ...
      <div className="max-w-3xl mx-auto">
        {!isLoggedIn ? (
          ...
          <Tabs defaultValue="upload" className="space-y-4">
            <TabsList className="grid w-full grid-cols-4 bg-brand-lightGray">
              <TabsTrigger value="upload" className="data-[state=active]:bg-brand-skyBlue data-[state=active]:text-white">Upload File</TabsTrigger>
